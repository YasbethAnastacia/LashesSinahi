...
export const Aboutme = () => {
    return (
        <section id="sobre-mi" className="relative overflow-hidden pb-15 pt-20 entrada-pagina ">
            <div className="mx-auto grid max-w-[1400px] grid-cols-[0.85fr_1.15fr] items-center gap-16 ">
                <div className="mx-auto w-full max-w-[500px] ">
                    
                            <div className="-z-20 relative flex h-[700px]  justify-center overflow-hidden rounded-t-full bg-[#f6dce2] pt-15 ">
                                <img className="-z-10 absolute inset-0 w-full h-full" src="/Aboutme/Mancha.png" alt="" />
                                <img src="/Aboutme/sinahi.png" alt="Sinahi realizando un servicio de belleza" className="h-full object-cover" loading="lazy" />
                            </div>
            ...
            <div className="w-full absolute bottom-10 -z-30">
                <img className="w-full " src="/Aboutme/onda3.svg" alt="" />
            </div>
        </section>
    );
};